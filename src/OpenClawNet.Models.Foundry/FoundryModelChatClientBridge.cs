...
/// <summary>
/// Bridges the existing <see cref="FoundryModelClient"/> to <see cref="IChatClient"/>
/// so the MAF provider infrastructure can use it without rewriting the HTTP logic.
/// </summary>
internal sealed class FoundryModelChatClientBridge : IChatClient
{
    private readonly FoundryModelClient _client;

    public FoundryModelChatClientBridge(FoundryModelClient client) => _client = client;
